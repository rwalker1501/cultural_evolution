...
#mm.run_experiment(base_path, "rpv12 no equatorials","rpv12 no equatorials OPT",globals_type="No equatorials",filter_min_date=0, filter_max_date=46000,date_window=24,low_res=False);
...
#
mm.run_experiment(base_path, "rpv12_fr_sp", "rpv12_fr_sp new_eps3", globals_type="France and Spain", date_window=24,low_res=True,filter_min_date=0, filter_max_date=46000)
#mm.run_experiment(base_path, "rpv12_au", "rpv12_au", globals_type="Australia", date_window=24,low_res=False,filter_min_date=0, filter_max_date=46000)
...
#mm.run_experiment(base_path, "rpv12 no equatorials", "rpv12_dat 10k-46k", globals_type="No equatorials",filter_min_date=10000, filter_max_date=46000,date_window=24,low_res=False)
