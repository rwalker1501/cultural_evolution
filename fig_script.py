...
mm.run_experiment(base_path, "rpv12 no equatorials exact direct", "rpv12 no equatorials exact direct NEWHR",globals_type="No equatorials",date_window=24,low_res=False);
