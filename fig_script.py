...
mm.run_experiment(base_path, "rpv10_fr_sp", "rpv10_fr_sp", the_globals="France and Spain")

# # FIG2E: OR graph for Australia, Eriksson
mm.run_experiment(base_path, "rpv10_au", "rpv10_au", the_globals="Australia")

# FIG2G: pGraph for world, Timmermann (as in Fig 2A)
# FIG2H: OR graph for world, Timmermann (as in Fig2B)
mm.run_experiment(base_path, "rpv10", "rpv10_timmermann", population_data_name="Timmermann");
...
mm.run_experiment(base_path, "rpv10", "rpv10_ca", is_confounder_analysis=True);
